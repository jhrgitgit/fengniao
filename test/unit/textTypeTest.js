define(function(require) {
	...
	describe("文本类型转换校验", function() {
		...
		it("获取数字格式数据测试", function() {
			...
			expect(textTypeHandler.getFormatNumber("", false, 0)).toEqual("0"); //空字符，去掉千分位
			expect(textTypeHandler.getFormatNumber("", true, 0)).toEqual("0"); //空字符，增加千分位
			...
			expect(textTypeHandler.getFormatNumber("",false,2)).toEqual("0.00"); //空字符，去掉千分位，显示2位小数：
