						...
						<div class="fui-body">
							...
							<span class="fui-layout">
								<div class="fui-section fui-transverse"  data-toolbar="cut">
									<div class="fui-transverse-model"><span class="fui-cf-ico ico-shear"></span><span class="fui-cf-text">剪切</span></div>
								</div>
								<div class="fui-section fui-transverse" data-toolbar="copy">
									<div class="fui-transverse-model"><span class="fui-cf-ico ico-copy"></span><span class="fui-cf-text">复制</span></div>
								</div>
							</span>
						</div>
					...
					<span class="fui-container">
						<div class="fui-body">
							<span class="fui-layout">
								...
								<div class="fui-transverse">
									<span class="ico-section" data-toolbar="bold"><span class="fui-cf-ico ico-weight"></span></span>
						...
						<div class="fui-body" id="textFormatContainer">
							<span class="fui-layout">
								<div class="fui-section fui-alone" data-toolbar="format">
									<div class="fui-cf-ico ico-textformat fui-cf-alone"></div>
							...
							<span class="fui-layout">
								<div class="fui-section fui-transverse" data-toolbar="merge" id="merge">
									<div class="fui-transverse-model">
										<span class="fui-cf-ico ico-combincells"></span>
